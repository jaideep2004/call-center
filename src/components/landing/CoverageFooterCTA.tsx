        ...
        <div className={styles.footerContent} ref={footerLinksRef}>
          ...
          <div className={styles.brandCol}>
            ...
            <div className={styles.socialRow}>
              ...
              <a href="#instagram" aria-label="Instagram" className={styles.socialBtn} style={{opacity:.45}}>
              ...
              <a href="#youtube" aria-label="YouTube" className={styles.socialBtn} style={{opacity:.45}}>
