...
export default function CampaignDetailPage() {
	...
	return (
		<div className='dashboard-page'>
			...
			<div
				className='split'
				style={{ "--gap": "var(--space-6)" } as React.CSSProperties}>
					...
					<section className='card' style={{ padding: "var(--space-6)" }}>
						...
						<dl className='data-list'>
							...
							<dd style={{ margin: "10px 0px" }}>
								<select
									className='input'
									value={campaign.publisher_id ?? ""}
									onChange={(e) =>
										update("publisher_id", e.target.value || null)
									}
									style={{ maxWidth: 200 }}>
							...
							<dd style={{ margin: "10px 0px" }}>
								<div style={{ display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center" }}>
									<span className='text-mono-sm' style={{ marginRight: 4 }}>$/call</span>
									<input
										className='input'
										type='number'
										min='0'
										...
										style={{ maxWidth: 110 }}
									/>
									<span className='text-mono-sm' style={{ marginRight: 4 }}>$/payout</span>
									<input
										className='input'
										type='number'
										min='0'
									...
									{bidOverride && (
										<button className='btn btn-sm' onClick={clearBid} disabled={bidSaving}>Clear</button>
									)}
								</div>
								<input
									className='input'
									...
									style={{ maxWidth: 340, marginTop: 6, display: "block" }}
								/>
								<span className='text-muted text-mono-sm' style={{ fontSize: 10 }}>
									Manual bid — applies immediately to billing and publisher payout. No schedule.
								</span>
							</dd>
							<dt>Retreaver CID</dt>
							<dd style={{ margin: "10px 0px" }}>
